...
export function PlanStage({ session, onChange }: SessionStageProps) {
  const advancedOpen = session.rigour.enabled;
  ...
  const toggleAdvanced = () => {
    onChange({ ...session, rigour: { ...session.rigour, enabled: !advancedOpen } });
  };
                ...
                <Card className="border-border bg-muted/20 shadow-none ring-0" key={objective.id} size="sm">
                  ...
                  <CardContent className="grid gap-4 md:grid-cols-2">
                    <div className="grid gap-2 md:col-span-2">
                      <Label htmlFor={`${objectiveId}-text`}>Learning objective</Label>
                    ...
                    <div className="grid gap-2">
                      <Label htmlFor={`${objectiveId}-assessment`}>Check for learning</Label>
                    ...
                    {advancedOpen && (
                      <div className="grid gap-4 rounded-lg border border-border bg-background p-3 md:col-span-2 md:grid-cols-2">
                        <div className="grid gap-2">
