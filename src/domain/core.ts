...
export function buildGibbsReflectionDraft(session: TeachingSession, feedback: FeedbackSummary): ReflectionDraft {
  return {
    ...
    sections: {
      ...
      analysis: `Explain why the session worked or did not work, using the feedback and observations you have. ${feedback.kirkpatrick.behaviour}`,
